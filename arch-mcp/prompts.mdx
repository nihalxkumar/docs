...
**Example Input:**
```
"My system won't boot, I get a grub rescue prompt"
```
...
```
User: "Can't start nginx service, getting permission denied"
...
```
User: "Is package-name safe to install?"
...
```
User: "What do I need to install package-name?"
