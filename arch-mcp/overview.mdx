...
<Columns cols={3}>
  ...
  <Frame caption="Example of finding better terminal alternatives">
    <img 
      src="/images/examples/better-terminal.png" 
      alt="Better terminal search example showing AUR search results" 
      style={{ borderRadius: '0.5rem' }}
    />
  </Frame>
