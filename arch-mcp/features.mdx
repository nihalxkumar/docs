...
>
  **9 URI schemes** for accessing Arch Wiki, AUR packages, official repos, system data, and package inventories
</Card>
...
<Card
  ...
  href="/arch-mcp/tools"
>
  **25 tools** covering search, security analysis, package lifecycle, and system diagnostics
</Card>
...
|------|-------|---------------|----------|
| **Resources** | 9 | URI schemes | Direct data access |
| **Tools** | 25 | Function calls | Single operations |
