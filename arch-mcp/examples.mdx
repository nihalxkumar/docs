...
<Frame caption="Example of complete security audit for Syncthing package">
  <img 
    src="/images/examples/syncthing-check.png" 
    alt="Syncthing security audit example showing comprehensive security analysis" 
    style={{ borderRadius: '0.5rem' }}
  />
</Frame>
